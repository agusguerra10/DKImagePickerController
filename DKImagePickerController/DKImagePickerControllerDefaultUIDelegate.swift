...
open class DKImagePickerControllerDefaultUIDelegate: NSObject, DKImagePickerControllerUIDelegate {
	...
	open func imagePickerController(_ imagePickerController: DKImagePickerController,
		...
		vc.navigationItem.leftBarButtonItem = UIBarButtonItem(barButtonSystemItem: .cancel,
                                                              ...
                                                              action: #selector(imagePickerController.dismiss as () -> Void) as Selector)
	}
    ...
    open func imagePickerController(_ imagePickerController: DKImagePickerController, didLongPressAt indexPath: IndexPath) {
